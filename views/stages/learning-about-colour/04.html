...
<div class="content">
    <div class="container text-drag">
        ...
        <div class="row mt-2 justify-content-center">
            ...
            <span id="drag1" draggable="true" ondragstart="drag(event)" width="45" height="45" class="mr-1 px-1 bg-light border border-dark">red</span>
            <span id="drag2" draggable="true" ondragstart="drag(event)" width="45" height="45" class="mr-1 px-1 bg-light border border-dark">yellow</span>
